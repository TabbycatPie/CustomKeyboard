...
_rf_pack rf_pack;
void handleSPIreceive(){
	if(SI24R1_Read_IRQ_Status() & RX_OK){
		//receive msg
		SI24R1_RecData((unsigned char*)&rf_pack,RX_PLOAD_WIDTH);
		SI24R1_RF_ClearIRQ(RX_OK);
		rf_CE = 1;
